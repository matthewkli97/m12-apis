...
plot(refugees.usa$year, refugees.usa$usa, type="o")
...
joined <- left_join(refugees.usa, refugees.tur, by='year')

joined <- mutate(joined, more.turkey = as.numeric(usa) < as.numeric(tur))
